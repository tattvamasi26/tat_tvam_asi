...
export interface UIStrings {
  ...
  // ── Stutis, by devata
  labelStotras: string;
  labelStotraOne: string;
  labelStotraMany: string;
  labelComingSoon: string;
  labelShowMeaning: string;
  labelHideMeaning: string;
  labelPhala: string;
...
const en: UIStrings = {
  ...
  labelStotraOne: "stotra",
  labelStotraMany: "stotras",
  labelComingSoon: "Coming soon",
  labelShowMeaning: "Show meaning",
  labelHideMeaning: "Hide meaning",
...
const kn: UIStrings = {
  ...
  labelStotraOne: "ಸ್ತೋತ್ರ",
  labelStotraMany: "ಸ್ತೋತ್ರಗಳು",
  labelComingSoon: "ಶೀಘ್ರದಲ್ಲೇ",
  labelShowMeaning: "ಅರ್ಥ ತೋರಿಸಿ",
  labelHideMeaning: "ಅರ್ಥ ಮರೆಮಾಡಿ",
  labelPhala: "ಫಲಶ್ರುತಿ",
...
const hi: UIStrings = {
  ...
  labelStotraOne: "स्तोत्र",
  labelStotraMany: "स्तोत्र",
  labelComingSoon: "जल्द आ रहे हैं",
  labelShowMeaning: "अर्थ दिखाएँ",
  labelHideMeaning: "अर्थ छिपाएँ",
  labelPhala: "फलश्रुति",
