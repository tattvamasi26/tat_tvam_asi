...
const rituals = [
  { time: "5:00 AM",        name: "Nirmalya Pooja",         desc: "The day begins before dawn. Previous day's offerings are cleared and the Swayambhu Lingam is revealed — the only time the raw linga is directly visible to early devotees." },
  ...
  { time: "9:00 AM",        name: "Nityotsava Pooja",        desc: "Daily festival worship with food offerings, Vedic chanting, and sahasranama archana — per the Vijayagama system established by Adi Shankaracharya." },
  ...
  { time: "6:30 PM",        name: "Pradosha Pooja",          desc: "As dusk falls, the evening worship begins. The goddess transforms into Parvati. The atmosphere shifts — the lamps multiply, the chanting deepens." },
    ...
    <div style={{ background: "var(--bg0)", minHeight: "100vh", color: "var(--text0)" }}>
      ...
      <div style={{ position: "relative", height: "90vh", minHeight: 560, overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
        <Image
          ...
          fill
          style={{ objectFit: "cover", objectPosition: "top", filter: "brightness(0.5) saturate(0.9)" }}
          priority
          unoptimized
        />
        ...
        <div style={{ position: "relative", zIndex: 1, padding: "0 2rem 6rem", maxWidth: 900, margin: "0 auto", width: "100%" }}>
          ...
          <p style={{ fontFamily: "var(--sans)", fontSize: "0.82rem", color: "rgba(237,228,208,0.55)", letterSpacing: "0.1em" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 2rem" }}>
        ...
        <section style={{ padding: "80px 0", borderBottom: "1px solid rgba(200,150,62,0.1)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "3rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", alignItems: "start" }}>
              <div>
                ...
                <p style={{ fontFamily: "var(--sans)", fontSize: "0.92rem", color: "var(--text1)", lineHeight: 2, fontWeight: 300, marginBottom: "1rem" }}>
                  There lived a demon named Kaumasura — fierce, determined to conquer the heavens. He undertook severe penance to propitiate Lord Shiva, seeking an invincible boon.
                </p>
                <p style={{ fontFamily: "var(--sans)", fontSize: "0.92rem", color: "var(--text1)", lineHeight: 2, fontWeight: 300 }}>
                  Sensing the grave danger, the goddess of speech — Saraswati herself — intervened and rendered the demon mute. Unable to speak his boon, Kaumasura became Mookasura — mooka meaning dumb.
                </p>
              </div>
              <div style={{ position: "relative", aspectRatio: "3/4", borderRadius: 2, overflow: "hidden" }}>
                <Image
                  src={IMGS.flowersEntrance}
                  alt="Flower offerings at the entrance of Sri Mookambika Temple, Kollur"
                  fill
                ...
                <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "0.8rem 1rem", background: "linear-gradient(to top, rgba(0,0,0,0.8), transparent)" }}>
                  <p style={{ fontFamily: "var(--sans)", fontSize: "0.62rem", color: "var(--text1)" }}>Flower offerings at the temple entrance — lotus, jasmine, and chrysanthemum</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p style={{ fontFamily: "var(--sans)", fontSize: "0.92rem", color: "var(--text1)", lineHeight: 2, fontWeight: 300 }}>
                Even voiceless, Mookasura was formidable. He defeated Indra and subjected the three worlds to chaos. The Trimurti called upon the Tridevi — Saraswati, Lakshmi, and Parvati — to create a form to defeat the asura. Their combined energies culminated into a goddess who slew Mookasura. She acquired the name Mookambika — the one who silenced the mute demon.
              </p>
            </div>

            {/* Deity gold image — full */}
            <div style={{ position: "relative", aspectRatio: "3/4", borderRadius: 2, overflow: "hidden" }}>
              <Image
                src={IMGS.deityGold}
                alt="Sri Mookambika Devi — adorned in gold with flanking deities"
                fill
              ...
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "2rem" }}>
                <p style={{ fontFamily: "var(--serif)", fontSize: "1.2rem", fontWeight: 300, color: "var(--text0)" }}>Mookambika Devi — adorned in gold</p>
                <p style={{ fontFamily: "var(--sans)", fontSize: "0.65rem", color: "var(--gold)", letterSpacing: "0.15em", textTransform: "uppercase", marginTop: "0.3rem" }}>The Panchaloha idol on Sri Chakra — Kollur sanctum</p>
              </div>
            </div>

            {/* Shankaracharya story box */}
            <div style={{ background: "var(--bg1)", border: "1px solid rgba(200,150,62,0.12)", padding: "2.5rem" }}>
              ...
              <p style={{ fontFamily: "var(--sans)", fontSize: "0.92rem", color: "var(--text1)", lineHeight: 2, fontWeight: 300, marginBottom: "1rem" }}>
                In the 8th century, Adi Shankaracharya traversed the Kodachadri hills and encountered the divine presence of Mookambika. He wished to bring her to Kerala — where no temple for the goddess existed. She agreed to follow him on one condition: that he walk ahead without looking back, guided only by the sound of her anklets.
              </p>
              <p style={{ fontFamily: "var(--sans)", fontSize: "0.92rem", color: "var(--text1)", lineHeight: 2, fontWeight: 300 }}>
                He walked. The anklets rang. Then suddenly — silence. Doubt overtook him. He looked back. The goddess chose to remain at that very spot in Kollur. But because of his austerities, she also agreed to be present at Chottanikkara in Kerala. Even today, Chottanikkara's doors open only after Kollur's — this daily rhythm maintained for over twelve centuries.
              </p>
            </div>
        ...
        <section style={{ padding: "80px 0", borderBottom: "1px solid rgba(200,150,62,0.1)" }}>
          ...
          {/* Silver palanquin deity + deepasthambha side by side */}
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem", marginBottom: "2.5rem" }}>
            <div style={{ position: "relative", aspectRatio: "3/4", borderRadius: 2, overflow: "hidden" }}>
              <Image
                src={IMGS.deitySilver}
                alt="Mookambika Devi in silver palanquin during festival procession"
                fill
                style={{ objectFit: "cover", objectPosition: "top" }}
                unoptimized
              />
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "1rem 1.2rem", background: "linear-gradient(to top, rgba(0,0,0,0.85), transparent)" }}>
                <p style={{ fontFamily: "var(--serif)", fontSize: "0.95rem", fontWeight: 300, color: "var(--text0)" }}>Devi in the silver palanquin</p>
                <p style={{ fontFamily: "var(--sans)", fontSize: "0.6rem", color: "var(--gold)", letterSpacing: "0.1em", marginTop: "0.2rem" }}>During the Rathotsava procession</p>
              </div>
            </div>
            <div style={{ position: "relative", aspectRatio: "3/4", borderRadius: 2, overflow: "hidden" }}>
              <Image
                src={IMGS.deepasthambha}
                alt="Deepasthambha and Dwajasthambha at Sri Mookambika Temple, Kollur"
                fill
                style={{ objectFit: "cover" }}
                unoptimized
              />
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "1rem 1.2rem", background: "linear-gradient(to top, rgba(0,0,0,0.85), transparent)" }}>
                <p style={{ fontFamily: "var(--serif)", fontSize: "0.95rem", fontWeight: 300, color: "var(--text0)" }}>Deepasthambha & Dwajasthambha</p>
                <p style={{ fontFamily: "var(--sans)", fontSize: "0.6rem", color: "var(--gold)", letterSpacing: "0.1em", marginTop: "0.2rem" }}>The lamp tower with 21 concentric circles — temple courtyard</p>
              </div>
            </div>
          </div>
          ...
          <div style={{ background: "var(--bg1)", border: "1px solid rgba(200,150,62,0.12)", padding: "2rem" }}>
            ...
            <p style={{ fontFamily: "var(--sans)", fontSize: "0.9rem", color: "var(--text1)", lineHeight: 1.9 }}>
              The huge lamp tower at the temple entrance has its base shaped like a tortoise's head and 21 concentric circles. When all lamps are lit and viewed from a distance, they appear similar to the divine Makara Jyothi of Sabarimala. A single flame maintained at this pillar represents the unbroken continuity of worship at Kollur across centuries.
            </p>
          </div>
        </section>
        ...
        <section style={{ padding: "80px 0", borderBottom: "1px solid rgba(200,150,62,0.1)" }}>
          ...
          <p style={{ fontFamily: "var(--sans)", fontSize: "0.92rem", color: "var(--text1)", lineHeight: 2, fontWeight: 300, marginBottom: "3rem" }}>
            The Vijayagama system — prescribed by Adi Shankaracharya — governs every ritual at Kollur to this day. Every gesture, every substance, every time of day has a reason rooted in Vedic cosmology. This is not tradition for tradition's sake — it is a living technology for encountering the divine.
          </p>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem" }}>
            {[
              { title: "Trikala Pooja",            desc: "Three daily worship sessions corresponding to the three aspects of Mookambika — Saraswati at dawn, Lakshmi at noon, Parvati at dusk." },
              ...
              { title: "Sri Chakra Worship",       desc: "The Devi stands on a Sri Chakra Yantra installed by Adi Shankara — the geometric body of the goddess. Every worship of the idol is simultaneously worship of the yantra." },
              { title: "Vidyarambham",             desc: "Children's first letters are written here, guided by the priest's hand. As the goddess of speech, Mookambika presides over the beginning of all learning." },
              { title: "Anna Prashana",            desc: "An infant's first solid food is offered before the goddess of nourishment. Two of life's most sacred beginnings — speech and food — consecrated at Kollur." },
              { title: "Bali Pooja",               desc: "Offerings made to the guardian energies of the temple complex. This ancient ritual acknowledges that the sacred space is inhabited by many presences." },
            ].map(p => (
        ...
        <section style={{ padding: "80px 0", borderBottom: "1px solid rgba(200,150,62,0.1)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
            {[
              { name: "Navaratri",  when: "Ashwin (Sep–Oct)", desc: "The nine nights of the goddess — the most significant festival at Kollur. Thousands arrive from Karnataka and Kerala. Chandi Homam, Sahasranama Archana, and special processions mark each night. The final day — Vijayadashami — marks the victory of the goddess over Mookasura, the very event for which this temple exists." },
              { name: "Rathotsava", when: "Phalguna (Feb–Mar)", desc: "The chariot festival. The goddess is placed in the great wooden chariot and pulled through the temple streets by devotees. Moola Nakshatra in this month is observed as Devi's birthday — one of the most auspicious days in the Tulunadu calendar. The silver palanquin visible in these photographs is used during the procession." },
        ...
        <section style={{ padding: "80px 0", borderBottom: "1px solid rgba(200,150,62,0.1)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", alignItems: "start" }}>
            <div>
              ...
              <p style={{ fontFamily: "var(--sans)", fontSize: "0.92rem", color: "var(--text1)", lineHeight: 2, fontWeight: 300 }}>
                Kollur is one of the Seven Mukti Sthalas of Parashurama Kshetra — alongside Udupi, Subrahmanya, Kumbasi, Kodeshwara, Sankaranarayana, and Gokarna. To visit all seven in one pilgrimage is a complete traversal of Tulunadu's sacred geography.
              </p>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 2, background: "var(--bg3)" }}>
              {[
                ...
                ["Shankaracharya Peetha", "The western side of sanctum where Shankara sat in meditation."],
                ["Saraswathi Mantapam",   "Southern mandapa — Vidyarambham and Anna Prashana are performed here."],
              ].map(([place, desc]) => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem" }}>
            <div>
              ...
              <div style={{ background: "var(--bg1)", border: "1px solid rgba(200,150,62,0.15)", padding: "2rem" }}>
                ...
                <p style={{ fontFamily: "var(--sans)", fontSize: "0.85rem", color: "var(--text1)", lineHeight: 1.85 }}>
                  <strong style={{ color: "var(--gold)", fontWeight: 400 }}>October – March</strong> — pleasant weather, ideal for Kodachadri surroundings.<br/><br/>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              {[
                ...
                { mode: "Dress Code",detail: "Men: white dhoti preferred. Women: traditional dress required. Footwear removed before the inner sanctum." },
