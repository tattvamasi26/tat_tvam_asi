...
export const STUTIS: TextRow[] = [
  ...
  { id: "t-stuti-ganesha-dvadasha-nama", slug: "ganesha-dvadasha-nama", work_type: "stotra", parent_id: null, name_sanskrit: "गणेशद्वादशनाम", name_iast: "Gaṇeśa Dvādaśa Nāma", veda: null, verse_count: 3, deity: "ganesha" },
  { id: "t-stuti-ganapati-mula-mantra", slug: "ganapati-mula-mantra", work_type: "stotra", parent_id: null, name_sanskrit: "गणपतिमूलमन्त्रः", name_iast: "Gaṇapati Mūla Mantra", veda: null, verse_count: 1, deity: "ganesha" },
  { id: "t-stuti-ganapati-atharvashirsha", slug: "ganapati-atharvashirsha", work_type: "stotra", parent_id: null, name_sanskrit: "गणपत्यथर्वशीर्षम्", name_iast: "Gaṇapatyatharvaśīrṣam", veda: null, verse_count: 14, deity: "ganesha" },
  { id: "t-stuti-ganesha-bhujangam", slug: "ganesha-bhujangam", work_type: "stotra", parent_id: null, name_sanskrit: "गणेशभुजङ्गम्", name_iast: "Gaṇeśa Bhujaṅgam", veda: null, verse_count: 8, deity: "ganesha" },
  { id: "t-stuti-ganeshashtakam", slug: "ganeshashtakam", work_type: "stotra", parent_id: null, name_sanskrit: "गणेशाष्टकम्", name_iast: "Gaṇeśāṣṭakam", veda: null, verse_count: 8, deity: "ganesha" },
...
export const CORPUS_TRANSLATIONS: TextTranslationRow[] = [
  ...
  // ── Stutis ──────────────────────────────────────────────
  { text_id: "t-stuti-gayatri-mantra", language: "en", name: "Gayatri Mantra", summary: "The Gayatri mantra from the Rigveda (3.62.10), said at dawn, noon and dusk.", key_teaching: "Dhiyo yo naḥ pracodayāt — may he set our minds in motion." },
  { text_id: "t-stuti-gayatri-mantra", language: "kn", name: "ಗಾಯತ್ರೀ ಮಂತ್ರ", summary: "ಋಗ್ವೇದದ (3.62.10) ಗಾಯತ್ರೀ ಮಂತ್ರ — ಮುಂಜಾನೆ, ಮಧ್ಯಾಹ್ನ ಮತ್ತು ಸಂಜೆ ಜಪಿಸುವ ಮಂತ್ರ.", key_teaching: "ಧಿಯೋ ಯೋ ನಃ ಪ್ರಚೋದಯಾತ್ — ಅವನು ನಮ್ಮ ಬುದ್ಧಿಯನ್ನು ಪ್ರೇರೇಪಿಸಲಿ." },
  { text_id: "t-stuti-gayatri-mantra", language: "hi", name: "गायत्री मंत्र", summary: "ऋग्वेद (3.62.10) का गायत्री मंत्र — प्रातः, मध्याह्न और सायं जपा जाने वाला मंत्र।", key_teaching: "धियो यो नः प्रचोदयात् — वे हमारी बुद्धि को प्रेरित करें।" },

  { text_id: "t-stuti-ganesha-dhyana", language: "en", name: "Ganesha Dhyana Shlokas", summary: "Four short verses to Ganesha, said before starting anything.", key_teaching: "Nirvighnaṃ kuru me deva — keep my undertakings free of obstacles." },
  { text_id: "t-stuti-ganesha-dhyana", language: "kn", name: "ಗಣೇಶ ಧ್ಯಾನ ಶ್ಲೋಕಗಳು", summary: "ಯಾವುದೇ ಕಾರ್ಯ ಆರಂಭಿಸುವ ಮೊದಲು ಹೇಳುವ ನಾಲ್ಕು ಚಿಕ್ಕ ಗಣೇಶ ಶ್ಲೋಕಗಳು.", key_teaching: "ನಿರ್ವಿಘ್ನಂ ಕುರು ಮೇ ದೇವ — ನನ್ನ ಕಾರ್ಯಗಳನ್ನು ವಿಘ್ನರಹಿತವಾಗಿಸು." },
  { text_id: "t-stuti-ganesha-dhyana", language: "hi", name: "गणेश ध्यान श्लोक", summary: "कोई भी कार्य आरंभ करने से पहले कहे जाने वाले गणेश के चार छोटे श्लोक।", key_teaching: "निर्विघ्नं कुरु मे देव — मेरे कार्यों को विघ्नरहित करो।" },

  { text_id: "t-stuti-gananam-tva", language: "en", name: "Gananam Tva", summary: "The Rigveda verse (2.23.1) with which pujas open in Ganapati's name.", key_teaching: "Gaṇānāṃ tvā gaṇapatiṃ havāmahe — we call you, lord of the hosts." },
  { text_id: "t-stuti-gananam-tva", language: "kn", name: "ಗಣಾನಾಂ ತ್ವಾ", summary: "ಗಣಪತಿಯ ಹೆಸರಿನಲ್ಲಿ ಪೂಜೆ ಆರಂಭಿಸುವ ಋಗ್ವೇದದ ಋಕ್ಕು (2.23.1).", key_teaching: "ಗಣಾನಾಂ ತ್ವಾ ಗಣಪತಿಂ ಹವಾಮಹೇ — ಗಣಗಳ ಒಡೆಯನೇ, ನಿನ್ನನ್ನು ಕರೆಯುತ್ತೇವೆ." },
  { text_id: "t-stuti-gananam-tva", language: "hi", name: "गणानां त्वा", summary: "ऋग्वेद की ऋचा (2.23.1), जिससे गणपति के नाम से पूजा आरंभ होती है।", key_teaching: "गणानां त्वा गणपतिं हवामहे — गणों के स्वामी, हम तुम्हें पुकारते हैं।" },

  { text_id: "t-stuti-ganesha-gayatri", language: "en", name: "Ganesha Gayatri", summary: "The Gayatri mantra of Ganesha, from the Ganapati Atharvashirsha.", key_teaching: "Tan no dantiḥ pracodayāt — may the tusked one set us in motion." },
  { text_id: "t-stuti-ganesha-gayatri", language: "kn", name: "ಗಣೇಶ ಗಾಯತ್ರೀ", summary: "ಗಣಪತಿ ಅಥರ್ವಶೀರ್ಷದಿಂದ ಗಣೇಶನ ಗಾಯತ್ರೀ ಮಂತ್ರ.", key_teaching: "ತನ್ನೋ ದಂತಿಃ ಪ್ರಚೋದಯಾತ್ — ದಂತವುಳ್ಳವನು ನಮ್ಮನ್ನು ಪ್ರೇರೇಪಿಸಲಿ." },
  { text_id: "t-stuti-ganesha-gayatri", language: "hi", name: "गणेश गायत्री", summary: "गणपति अथर्वशीर्ष से गणेश का गायत्री मंत्र।", key_teaching: "तन्नो दन्तिः प्रचोदयात् — वे दंतधारी हमें प्रेरित करें।" },

  { text_id: "t-stuti-sankatanashana", language: "en", name: "Sankatanashana Ganesha Stotram", summary: "Twelve names of Ganesha from the Narada Purana, recited to remove difficulties.", key_teaching: "Vidyārthī labhate vidyām — the seeker of learning gains learning." },
  { text_id: "t-stuti-sankatanashana", language: "kn", name: "ಸಂಕಟನಾಶನ ಗಣೇಶ ಸ್ತೋತ್ರ", summary: "ಸಂಕಟಗಳ ನಿವಾರಣೆಗಾಗಿ ಪಠಿಸುವ, ನಾರದ ಪುರಾಣದ ಗಣೇಶನ ಹನ್ನೆರಡು ನಾಮಗಳು.", key_teaching: "ವಿದ್ಯಾರ್ಥೀ ಲಭತೇ ವಿದ್ಯಾಂ — ವಿದ್ಯೆ ಬಯಸುವವನು ವಿದ್ಯೆಯನ್ನು ಪಡೆಯುತ್ತಾನೆ." },
  { text_id: "t-stuti-sankatanashana", language: "hi", name: "संकटनाशन गणेश स्तोत्र", summary: "संकट दूर करने के लिए पढ़े जाने वाले, नारद पुराण के गणेश के बारह नाम।", key_teaching: "विद्यार्थी लभते विद्यां — विद्या चाहने वाला विद्या पाता है।" },

  { text_id: "t-stuti-ganesha", language: "en", name: "Ganesha Pancharatnam", summary: "Five verses to Ganesha by Adi Shankaracharya, with a closing verse on the benefit of reciting them.", key_teaching: "Sung at the beginning of any undertaking." },
  { text_id: "t-stuti-ganesha", language: "kn", name: "ಗಣೇಶ ಪಂಚರತ್ನ", summary: "ಆದಿ ಶಂಕರಾಚಾರ್ಯರು ರಚಿಸಿದ ಗಣೇಶನ ಐದು ಶ್ಲೋಕಗಳು, ಫಲಶ್ರುತಿಯೊಂದಿಗೆ.", key_teaching: "ಯಾವುದೇ ಕಾರ್ಯದ ಆರಂಭದಲ್ಲಿ ಹಾಡಲಾಗುತ್ತದೆ." },
  { text_id: "t-stuti-ganesha", language: "hi", name: "गणेश पंचरत्न", summary: "आदि शंकराचार्य द्वारा रचित गणेश के पाँच श्लोक, फलश्रुति सहित।", key_teaching: "किसी भी कार्य के आरंभ में गाया जाता है।" },

  { text_id: "t-stuti-ganesha-dvadasha-nama", language: "en", name: "Ganesha Dvadasha Nama", summary: "The twelve names of Ganesha from the Ganesha Purana, said before study, a wedding, a journey or any new start.", key_teaching: "Vighnas tasya na jāyate — no obstacle arises for them." },
  { text_id: "t-stuti-ganesha-dvadasha-nama", language: "kn", name: "ಗಣೇಶ ದ್ವಾದಶ ನಾಮ", summary: "ವಿದ್ಯಾರಂಭ, ವಿವಾಹ, ಪ್ರಯಾಣ ಅಥವಾ ಯಾವುದೇ ಹೊಸ ಆರಂಭದ ಮೊದಲು ಹೇಳುವ, ಗಣೇಶ ಪುರಾಣದ ಗಣೇಶನ ಹನ್ನೆರಡು ನಾಮಗಳು.", key_teaching: "ವಿಘ್ನಸ್ತಸ್ಯ ನ ಜಾಯತೇ — ಅವನಿಗೆ ಯಾವ ವಿಘ್ನವೂ ಉಂಟಾಗದು." },
  { text_id: "t-stuti-ganesha-dvadasha-nama", language: "hi", name: "गणेश द्वादश नाम", summary: "विद्यारंभ, विवाह, यात्रा या किसी भी नए आरंभ से पहले कहे जाने वाले, गणेश पुराण के गणेश के बारह नाम।", key_teaching: "विघ्नस्तस्य न जायते — उसे कोई विघ्न नहीं होता।" },

  { text_id: "t-stuti-ganapati-mula-mantra", language: "en", name: "Ganapati Mula Mantra", summary: "Om Gam Ganapataye Namah — Ganesha's root mantra, from the Ganapati Atharvashirsha, said in japa.", key_teaching: "Gaṃ is his seed syllable." },
  { text_id: "t-stuti-ganapati-mula-mantra", language: "kn", name: "ಗಣಪತಿ ಮೂಲಮಂತ್ರ", summary: "ಓಂ ಗಂ ಗಣಪತಯೇ ನಮಃ — ಗಣಪತಿ ಅಥರ್ವಶೀರ್ಷದಿಂದ ಬಂದ, ಜಪಿಸುವ ಗಣೇಶನ ಮೂಲಮಂತ್ರ.", key_teaching: "ಗಂ ಅವನ ಬೀಜಾಕ್ಷರ." },
  { text_id: "t-stuti-ganapati-mula-mantra", language: "hi", name: "गणपति मूल मंत्र", summary: "ॐ गं गणपतये नमः — गणपति अथर्वशीर्ष से, जप किया जाने वाला गणेश का मूल मंत्र।", key_teaching: "गं उनका बीजाक्षर है।" },

  { text_id: "t-stuti-ganapati-atharvashirsha", language: "en", name: "Ganapati Atharvashirsha", summary: "The Ganapati Upanishad: Ganesha as Brahman, his mantra and his form, in fourteen sections. Widely recited on Ganesha Chaturthi.", key_teaching: "Tvam eva pratyakṣaṃ tattvam asi — you alone are the truth before our eyes." },
  { text_id: "t-stuti-ganapati-atharvashirsha", language: "kn", name: "ಗಣಪತಿ ಅಥರ್ವಶೀರ್ಷ", summary: "ಗಣಪತಿ ಉಪನಿಷತ್ತು: ಬ್ರಹ್ಮಸ್ವರೂಪನಾದ ಗಣೇಶ, ಅವನ ಮಂತ್ರ ಮತ್ತು ರೂಪ — ಹದಿನಾಲ್ಕು ಭಾಗಗಳಲ್ಲಿ. ಗಣೇಶ ಚತುರ್ಥಿಯಂದು ವ್ಯಾಪಕವಾಗಿ ಪಠಿಸಲಾಗುತ್ತದೆ.", key_teaching: "ತ್ವಮೇವ ಪ್ರತ್ಯಕ್ಷಂ ತತ್ತ್ವಮಸಿ — ಕಣ್ಣೆದುರಿನ ಸತ್ಯವು ನೀನೇ." },
  { text_id: "t-stuti-ganapati-atharvashirsha", language: "hi", name: "गणपति अथर्वशीर्ष", summary: "गणपति उपनिषद्: ब्रह्मस्वरूप गणेश, उनका मंत्र और उनका रूप — चौदह खंडों में। गणेश चतुर्थी पर व्यापक रूप से इसका पाठ होता है।", key_teaching: "त्वमेव प्रत्यक्षं तत्त्वमसि — प्रत्यक्ष तत्त्व तुम ही हो।" },

  { text_id: "t-stuti-ganesha-bhujangam", language: "en", name: "Ganesha Bhujangam", summary: "Eight verses to Ganesha ascribed to Adi Shankaracharya, in the gliding bhujangaprayata metre, with a closing verse.", key_teaching: "Gaṇeśe vibhau durlabhaṃ kiṃ prasanne — when Ganesha is pleased, what is hard to gain?" },
  { text_id: "t-stuti-ganesha-bhujangam", language: "kn", name: "ಗಣೇಶ ಭುಜಂಗಂ", summary: "ಆದಿ ಶಂಕರಾಚಾರ್ಯರದೆಂದು ಹೇಳಲಾಗುವ, ಭುಜಂಗಪ್ರಯಾತ ಛಂದಸ್ಸಿನ ಎಂಟು ಗಣೇಶ ಶ್ಲೋಕಗಳು, ಫಲಶ್ರುತಿಯೊಂದಿಗೆ.", key_teaching: "ಗಣೇಶೇ ವಿಭೌ ದುರ್ಲಭಂ ಕಿಂ ಪ್ರಸನ್ನೇ — ಗಣೇಶನು ಪ್ರಸನ್ನನಾದರೆ ಯಾವುದು ದುರ್ಲಭ?" },
  { text_id: "t-stuti-ganesha-bhujangam", language: "hi", name: "गणेश भुजंगम्", summary: "आदि शंकराचार्य को आरोपित, भुजंगप्रयात छंद में गणेश के आठ श्लोक, फलश्रुति सहित।", key_teaching: "गणेशे विभौ दुर्लभं किं प्रसन्ने — गणेश प्रसन्न हों तो क्या दुर्लभ है?" },

  { text_id: "t-stuti-ganeshashtakam", language: "en", name: "Ganesha Ashtakam", summary: "Eight verses from the Ganesha Purana, sung by all beings to Ganesha as the source of everything, with the verse he speaks after them.", key_teaching: "Sadā taṃ gaṇeśaṃ namāmo bhajāmaḥ — that Ganesha we always bow to and worship." },
  { text_id: "t-stuti-ganeshashtakam", language: "kn", name: "ಗಣೇಶಾಷ್ಟಕ", summary: "ಎಲ್ಲದರ ಮೂಲನಾದ ಗಣೇಶನಿಗೆ ಸಕಲ ಜೀವಿಗಳು ಹಾಡಿದ, ಗಣೇಶ ಪುರಾಣದ ಎಂಟು ಶ್ಲೋಕಗಳು, ಅವನು ನಂತರ ಹೇಳುವ ಶ್ಲೋಕದೊಂದಿಗೆ.", key_teaching: "ಸದಾ ತಂ ಗಣೇಶಂ ನಮಾಮೋ ಭಜಾಮಃ — ಆ ಗಣೇಶನಿಗೆ ಸದಾ ನಮಿಸುತ್ತೇವೆ, ಭಜಿಸುತ್ತೇವೆ." },
  { text_id: "t-stuti-ganeshashtakam", language: "hi", name: "गणेशाष्टकम्", summary: "सबके मूल गणेश के लिए समस्त प्राणियों द्वारा गाए गए, गणेश पुराण के आठ श्लोक, उसके बाद उनके कहे श्लोक के साथ।", key_teaching: "सदा तं गणेशं नमामो भजामः — उन गणेश को हम सदा नमन करते हैं, उनका भजन करते हैं।" },
